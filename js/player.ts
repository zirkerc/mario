class Player extends Entity {
	...
	setAnimation() {
		...
		if (this.starTime) {
			...
			if (this.starTime == 0) {
				switch (this.power) {
					case 0: this.sprite.pos.y = 32; break;
					case 1: this.sprite.pos.y = 0; break;
					case 2: this.sprite.pos.y = 96; break;
				}
			}
		}
		...
		if (this.flagging) {
			...
			if (this.vel.y === 0) this.sprite.frames = [0];
		}
	...
	pipe(direction: PipeDirection, destination: () => void) {
		sounds.pipe.play();
		this.piping = true;
