var oneonetunnel = Mario.oneonetunnel = function () {
  let levelOptions: LevelOptions = {
    ...
    scrolling: false,
    coinSprite: function () {
      return new Mario.Sprite('sprites/items.png', new Point(0, 96), [16, 16], 6, [0, 0, 0, 0, 1, 2, 1]);
    },
    floorSprite: new Mario.Sprite('sprites/tiles.png', new Point(0, 32), [16, 16], 0),
    wallSprite: new Mario.Sprite('sprites/tiles.png', new Point(32, 32), [16, 16], 0),
    ...
    LPipeSprites: [
      new Mario.Sprite('sprites/tiles.png', new Point(32, 128), [16, 16], 0),
      new Mario.Sprite('sprites/tiles.png', new Point(32, 144), [16, 16], 0),
      new Mario.Sprite('sprites/tiles.png', new Point(48, 128), [16, 16], 0),
      new Mario.Sprite('sprites/tiles.png', new Point(48, 144), [16, 16], 0),
      new Mario.Sprite('sprites/tiles.png', new Point(64, 128), [16, 16], 0),
      new Mario.Sprite('sprites/tiles.png', new Point(64, 144), [16, 16], 0),
    ]
